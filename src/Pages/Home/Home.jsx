...
const Home = () => {
    ...
    return (
        <div>
            ...
            <h1 className="text-center text-3xl sm:text-4xl lg:text-5xl text-yellow-600 font-semibold pt-10 pb-10">Our Products</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4 sm:px-8 lg:px-28">
                {products.length > 0 ? (
