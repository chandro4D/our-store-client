...
const Footer = () => {
    return (
        <div className="mt-20">
            <footer className="footer text-white  bg-sky-500 md:h-[250px] lg:h-[400px]   ">

                <div className="flex  ">
                    <div className="lg:text-xl md:text-sm lg:w-[200px] md:w-[80px] lg:mr-[250px] md:mr-[5px] lg:ml-[200px] md:ml-[2px]  mt-20 " >
                    <a className="text-white text-4xl font-medium ml-[35px]  pt-3"> <span className="text-purple-600">O</span>ur<span className="text-purple-600">S</span>tore</a>
                        <br />
                        <br />
                        <p className=" text-center underline" >support</p>
                        <p className=" text-center" >+880 17 59 62 64 70</p>
                      
                        <p className=" text-center">support@ourstore.com</p>
                        <br />
